  ...
  useEffect(() => {
    ...
    const fetchData = async (trf_id: any) => {
      try {
        ...
        form.setValue("prodcut_id", data.product_id);
        ...
        form.setValue("customer_address_line1", data?.product?.customer_address_line1);
        form.setValue("customer_address_line2", data?.product?.customer_address_line2);
      ...
      <div className="p-6.5">
        ...
        <div className="mb-4">
          <div className="border-b border-stroke py-4 px-2 dark:border-strokedark">
            <h3 className="font-medium text-black dark:text-white">Batches</h3>
          </div>
