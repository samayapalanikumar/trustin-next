...
async function getData(id: string) {
  ...
  const res3 = await fetch("http://localhost:8000/testtypes/", {
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${access_token?.value}`,
    },
  });
  const res4 = await fetch(`http://localhost:8000/parameters/${id}`, {
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${access_token?.value}`,
    },
      ...
      <div className="grid grid-cols-1 gap-9 sm:grid-cols-1">
        <div className="flex flex-col gap-9">
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form action={updateParameterWithId}>
              <div className="p-6.5">
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      name="branch_id"
                      defaultValue={data.parameter.branch_id}
                ...
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      name="product_id"
                      defaultValue={data.parameter.product_id}
                ...
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      name="test_type_id"
                      defaultValue={data.parameter.test_type_id}
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    ...
                    defaultValue={data.parameter.testing_parameters}
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    type="number"
                    name="amount"
                    defaultValue={data.parameter.amount}
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    type="text"
                    name="method_or_spec"
                    defaultValue={data.parameter.method_or_spec}
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    defaultValue={data.parameter.group_of_test_parameters}
