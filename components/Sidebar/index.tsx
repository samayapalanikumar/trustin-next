                  ...
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        ...
                        >
                          <ul className="mb-6 mt-2 flex flex-col gap-2.5 gap-y-8">
...
const DownAndUpSvg = ({ open }: { open: boolean }) => (
  <svg
